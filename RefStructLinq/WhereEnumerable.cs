...
public ref struct WhereEnumerable<T, TEnumerable, TEnumerator>(in TEnumerable inner, Func<T, bool> predicate)
    : IRefStructEnumerable<T, WhereEnumerator<T, TEnumerator>>
